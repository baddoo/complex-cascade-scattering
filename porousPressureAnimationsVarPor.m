...
imageFolder = '../../../general-presentations/images/';
...
%print(['../../../general-presentations/images/animated-images/porVarCase',num2str(l1),'plot',num2str(l)],'-dpng','-r50');
end
...
latexPNGNAR(['transRef',num2str(l1)],imageFolder,gca);
%close
end