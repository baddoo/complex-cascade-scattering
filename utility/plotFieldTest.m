function plotFieldTest(h,ADData,AAData,plotData,type)
...
h=pcolor(real(newcoord),imag(newcoord),real(h2 + 0*hIncFinPer));
...
for l = -nP:nP
   ...
   plot(real(rot*loc),imag(rot*loc),'k','LineWidth',1) 
end
