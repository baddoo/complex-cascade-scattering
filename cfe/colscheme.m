...
%
% append 'n' to cs to get color schemes based on the NIST scaling of phase
...
% coloring zeros black, poles white, % undefined values gray 
...
%y = sawfctxk(x,xk)
% sawtooth function on [0,1] with values in [0,1] and jumps at points xk
